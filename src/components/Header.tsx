...
export function Header() {
  ...
  return (
    <>
      {/* Steady sticky full-width glass band — no scroll morph / floating pill
          (those hurt scroll performance and layout stability on low-end phones). */}
      <header className="sticky top-0 z-50 border-b border-border/60 bg-background/75 pt-[env(safe-area-inset-top)] shadow-[inset_0_1px_0_0_rgba(255,255,255,0.45),0_8px_30px_-18px_rgba(0,31,63,0.16)] backdrop-blur-xl backdrop-saturate-150 dark:shadow-[inset_0_1px_0_0_rgba(255,255,255,0.05),0_8px_30px_-16px_rgba(0,0,0,0.5)]">
        <div className="container-shell">
          <div className="flex h-[76px] w-full items-center justify-between gap-2 sm:h-[84px] sm:gap-3">
            <Link
              href="/"
