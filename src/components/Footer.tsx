      ...
      <Container>
        ...
        <div className="flex flex-col items-center border-t border-slate-400/10 py-10 sm:flex-row-reverse sm:justify-between">
          <div className="flex gap-x-6">
            <Link href="#" className="group" aria-label="Zenvana on X">
              <svg
            ...
            <Link href="#" className="group" aria-label="Zenvana on GitHub">
              <svg
                className="h-6 w-6 fill-muted-foreground group-hover:fill-foreground"
                aria-hidden="true"
                viewBox="0 0 24 24"
          ...
          <p className="mt-6 text-sm text-muted-foreground sm:mt-0">
            Copyright &copy; {new Date().getFullYear()} Zenvana Hotels. All rights
            reserved.
          </p>
          <p className="mt-6 text-sm text-muted-foreground sm:mt-0">
