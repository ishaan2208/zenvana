...
import { CheckoutCouponProvider, LiveBookingTotal } from './CheckoutCouponState'
import {
...
export default async function CheckoutPage({ params, searchParams }: Props) {
            ...
            <Container className="relative py-6 sm:py-10 lg:py-20">
              <div className="grid gap-6 xl:grid-cols-[minmax(0,1fr)_340px] xl:items-start xl:gap-10">
                <div className="max-w-4xl">
                  <div className="hidden items-center gap-2 rounded-full border border-border/70 bg-card/70 px-3 py-1.5 text-[10px] uppercase tracking-[0.28em] text-muted-foreground backdrop-blur-sm sm:inline-flex">
                    <Sparkles className="h-3.5 w-3.5" />
                    Checkout
                  </div>

                  <BookingSteps current={3} className="mt-1 sm:mt-3" />
                  ...
                  <p className="mt-3 max-w-2xl text-sm leading-7 text-muted-foreground sm:mt-5 sm:text-base sm:leading-8 lg:text-lg">
                    Review your multi-room selection and enter guest details to
                    confirm the stay.
                  </p>
                ...
                <div className="hidden xl:block xl:pt-6">
                  <div className="rounded-[2rem] border border-border/60 bg-card/70 p-5 shadow-[0_18px_45px_rgba(8,17,31,0.04)] dark:bg-card/50">
                    ...
                    <p className="mt-3 text-sm leading-7 text-muted-foreground">
                      Once confirmed, your booking reference will be generated
                      immediately.
                    </p>
                    ...
                    <div className="mt-5 border-t border-border/60 pt-5">
                      <div className="flex items-start gap-3">
                        ...
                        <p className="text-sm leading-7 text-muted-foreground">
                          You are booking directly with the property for a
                          clearer and more reliable arrival experience.
                        </p>
                      </div>
                    </div>
                  </div>
          ...
          <Container className="relative py-6 sm:py-10 lg:py-20">
            <div className="grid gap-6 xl:grid-cols-[minmax(0,1fr)_340px] xl:items-start xl:gap-10">
              <div className="max-w-4xl">
                ...
                <p className="mt-3 max-w-2xl text-sm leading-7 text-muted-foreground sm:mt-5 sm:text-base sm:leading-8 lg:text-lg">
                  Review your slot and enter guest details to confirm the
                  booking.
                </p>
                ...
                <div className="rounded-[2rem] border border-border/60 bg-card/70 p-5 shadow-[0_18px_45px_rgba(8,17,31,0.04)] dark:bg-card/50">
                  ...
                  <div className="mt-5 border-t border-border/60 pt-5">
                    <div className="flex items-start gap-3">
                      ...
                      <p className="text-sm leading-7 text-muted-foreground">
                        Direct booking gives you a smoother line to the property
                        before arrival.
                      </p>
                    </div>
                  </div>
  ...
  if (missing.length > 0) {
    redirect(
      `/book/${slug}/rooms?checkIn=${q.checkIn ?? ''}&checkOut=${
        q.checkOut ?? ''
      }`,
    )
  }
          ...
          <Container className="relative py-6 sm:py-10 lg:py-20">
            <div className="grid gap-6 xl:grid-cols-[minmax(0,1fr)_340px] xl:items-start xl:gap-10">
              <div className="max-w-4xl">
                ...
                <p className="mt-3 max-w-2xl text-sm leading-7 text-muted-foreground sm:mt-5 sm:text-base sm:leading-8 lg:text-lg">
                  Review the stay details and enter guest information to confirm
                  the booking.
                </p>
                ...
                <div className="flex flex-wrap gap-2">
                  <Link
                    href={(() => {
                      ...
                      if (occupancy != null)
                        params.set('occupancy', String(occupancy))
